...
data class PlayerArgs(
    ...
    companion object {
        const val ROUTE = "player/{kind}/{streamId}/{title}/{ext}/{series}/{season}/{episode}/{pos}"
        ...
        fun toRoute(args: PlayerArgs): String {
            ...
            return "player/${args.kind.name}/${args.streamId}/$title/$ext/${args.seriesId}/${args.seasonNumber}/$episode/${args.startPositionMs}"
        }
